...
#  sed -i -e "s/# joypad_autoconfig_dir = \joypad_autoconfig_dir = "\/storage\/.kodi\/addons\/emulator.RetroArch\/autoconfig\"/" $INSTALL/etc/retroarch.cfg $INSTALL/etc/retroarch.cfg
